...
- (id <ResKnifePluginProtocol>)openResourceUsingEditor:(Resource *)resource
{
	...
	if(editorClass)
	{
		...
		return [(id <ResKnifePluginProtocol>)[editorClass alloc] initWithResource:resource];
	}
...
- (id <ResKnifePluginProtocol>)openResource:(Resource *)resource usingTemplate:(NSString *)templateName
{
	...
	{
		[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(resourceDataDidChange:) name:ResourceDataDidChangeNotification object:resource];
		return [(id <ResKnifeTemplatePluginProtocol>)[editorClass alloc] initWithResources:resource, tmpl, nil];
	}
