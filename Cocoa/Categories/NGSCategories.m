...
- (NSUInteger)indexOfFirstObjectReturningValue:(id)value forKey:(id)key
{
...
- (BOOL)isWithinRange:(NSRange)range				// location <= self <= location+length
{
	...
	return [self compare:[NSNumber numberWithUnsignedInteger:range.location]] != NSOrderedAscending && [self compare:[NSNumber numberWithUnsignedInteger:range.location+range.length]] != NSOrderedDescending;
}
- (BOOL)isExclusivelyWithinRange:(NSRange)range		// location < self < location+length
{
	...
	return [self compare:[NSNumber numberWithUnsignedInteger:range.location]] == NSOrderedDescending && [self compare:[NSNumber numberWithUnsignedInteger:range.location+range.length]] == NSOrderedAscending;
}
- (BOOL)isBoundedByRange:(NSRange)range				// location <= self < location+length
{
	...
	return [self compare:[NSNumber numberWithUnsignedInteger:range.location]] != NSOrderedAscending && [self compare:[NSNumber numberWithUnsignedInteger:range.location+range.length]] == NSOrderedAscending;
}
@end
